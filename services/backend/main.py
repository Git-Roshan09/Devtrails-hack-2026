...
from api import payouts, monitoring, webhooks, kyc
...
app.include_router(webhooks.router)  # Has own prefix /api/webhooks
app.include_router(kyc.router)  # Has own prefix /api/kyc
